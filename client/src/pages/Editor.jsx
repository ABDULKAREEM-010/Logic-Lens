...
const Editor = ({ code = '', setCode = () => {} }) => {
  ...
  const analyzeGithubMultiFiles = async (parsedFiles) => {
    ...
    try {
      ...
      const res = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/analyze/multi`, formData, {
  ...
  const reAnalyzeSingleFile = async (fileIndex = activeFileIndex) => {
    ...
    try {
      ...
      const response = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/analyze`, {
  ...
  const handleSingleFileAnalyze = async () => {
    ...
    try {
      const res = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/analyze`, {
